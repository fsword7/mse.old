...
const vaxOpcode vaxOpcodes[] = {
	...
	OPC("CVTPS",    OPC_nCVTPS,    4, OPR({ RW, AB, RW, AB, 0,  0  }), OPC_REG),
	OPC("CVTSP",    OPC_nCVTSP,    4, OPR({ RW, AB, RW, AB, 0,  0  }), OPC_REG),
	OPC("INDEX",    OPC_nINDEX,    6, OPR({ RL, RL, RL, RL, RL, WL }), OPC_REG),
	OPC("CRC",      OPC_nCRC,      4, OPR({ AB, RL, RW, AB, 0,  0  }), OPC_REG),
	...
	OPC("ADDP4",    OPC_nADDP4,    4, OPR({ RW, AB, RW, AB, 0,  0  }), OPC_REG),
	OPC("ADDP6",    OPC_nADDP6,    6, OPR({ RW, AB, RW, AB, RW, AB }), OPC_REG),
	OPC("SUBP4",    OPC_nSUBP4,    4, OPR({ RW, AB, RW, AB, 0,  0  }), OPC_REG),
	OPC("SUBP6",    OPC_nSUBP6,    6, OPR({ RW, AB, RW, AB, RW, AB }), OPC_REG),
	OPC("CVTPT",    OPC_nCVTPT,    5, OPR({ RW, AB, AB, RW, AB, 0  }), OPC_REG),
	OPC("MULP",     OPC_nMULP6,    6, OPR({ RW, AB, RW, AB, RW, AB }), OPC_REG),
	OPC("CVTTP",    OPC_nCVTTP,    5, OPR({ RW, AB, AB, RW, AB, 0  }), OPC_REG),
	OPC("DIVP",     OPC_nDIVP6,    6, OPR({ RW, AB, RW, AB, RW, AB }), OPC_REG),

	OPC("MOVC3",    OPC_nMOVC3,    3, OPR({ RW, AB, AB, 0,  0,  0  }), OPC_REG),
	...
	OPC("MOVP",     OPC_nMOVP,     3, OPR({ RW, AB, AB, 0,  0,  0  }), OPC_REG),
	OPC("CMPP3",    OPC_nCMPP3,    3, OPR({ RW, AB, AB, 0,  0,  0  }), OPC_REG),
	OPC("CVTPL",    OPC_nCVTPL,    3, OPR({ RW, AB, WL, 0,  0,  0  }), OPC_REG),
	OPC("CMPP4",    OPC_nCMPP4,    4, OPR({ RW, AB, RW, AB, 0,  0  }), OPC_REG),

	OPC("EDITPC",   OPC_nEDITPC,   4, OPR({ RW, AB, AB, AB, 0,  0  }), OPC_REG),
	OPC("MATCGC",   OPC_nMATCHC,   4, OPR({ RW, AB, RW, AB, 0,  0  }), OPC_REG),
	OPC("LOCC",     OPC_nLOCC,     3, OPR({ RB, RW, AB, 0,  0,  0  }), OPC_REG),
	OPC("SKPC",     OPC_nSKPC,     3, OPR({ RB, RW, AB, 0,  0,  0  }), OPC_REG),
	...
	OPC("ADDF2",    OPC_nADDF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_REG),
	OPC("ADDF3",    OPC_nADDF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_REG),
	OPC("SUBF2",    OPC_nSUBF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_REG),
	OPC("SUBF3",    OPC_nSUBF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_REG),
	OPC("MULF2",    OPC_nMULF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_REG),
	OPC("MULF3",    OPC_nMULF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_REG),
	OPC("DIVF2",    OPC_nDIVF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_REG),
	OPC("DIVF3",    OPC_nDIVF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_REG),

	OPC("CVTFB",    OPC_nCVTFB,    2, OPR({ RF, WB, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTFW",    OPC_nCVTFW,    2, OPR({ RF, WW, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTFL",    OPC_nCVTFL,    2, OPR({ RF, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTRFL",   OPC_nCVTRFL,   2, OPR({ RF, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTBF",    OPC_nCVTBF,    2, OPR({ RB, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTWF",    OPC_nCVTWF,    2, OPR({ RW, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTLF",    OPC_nCVTLF,    2, OPR({ RL, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("ACBF",     OPC_nACBF,     4, OPR({ RF, RF, MF, BW, 0,  0  }), OPC_REG),

	OPC("MOVF",     OPC_nMOVF,     2, OPR({ RF, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("CMPF",     OPC_nCMPF,     2, OPR({ RF, RF, 0,  0,  0,  0  }), OPC_REG),
	OPC("MNEGF",    OPC_nMNEGF,    2, OPR({ RF, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("TSTF",     OPC_nTSTF,     1, OPR({ RF, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("EMODF",    OPC_nEMODF,    5, OPR({ RF, RB, RF, WL, WF, 0  }), OPC_REG),
	OPC("POLYF",    OPC_nPOLYF,    3, OPR({ RF, RW, AB, 0,  0,  0  }), OPC_REG),
	OPC("CVTFD",    OPC_nCVTFD,    2, OPR({ RF, WD, 0,  0,  0,  0  }), OPC_REG),
	...
	OPC("ADDD2",    OPC_nADDD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_REG),
	OPC("ADDD3",    OPC_nADDD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_REG),
	OPC("SUBD2",    OPC_nSUBD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_REG),
	OPC("SUBD3",    OPC_nSUBD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_REG),
	OPC("MULD2",    OPC_nMULD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_REG),
	OPC("MULD3",    OPC_nMULD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_REG),
	OPC("DIVD2",    OPC_nDIVD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_REG),
	OPC("DIVD3",    OPC_nDIVD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_REG),

	OPC("CVTDB",    OPC_nCVTDB,    2, OPR({ RD, WB, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTDW",    OPC_nCVTDW,    2, OPR({ RD, WW, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTDL",    OPC_nCVTDL,    2, OPR({ RD, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTRDL",   OPC_nCVTRDL,   2, OPR({ RD, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTBD",    OPC_nCVTBD,    2, OPR({ RB, WD, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTWD",    OPC_nCVTWD,    2, OPR({ RW, WD, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTLD",    OPC_nCVTLD,    2, OPR({ RL, WD, 0,  0,  0,  0  }), OPC_REG),
	OPC("ACBD",     OPC_nACBD,     4, OPR({ RD, RD, MD, BW, 0,  0  }), OPC_REG),

	OPC("MOVD",     OPC_nMOVD,     2, OPR({ RD, WD, 0,  0,  0,  0  }), OPC_REG),
	OPC("CMPD",     OPC_nCMPD,     2, OPR({ RD, RD, 0,  0,  0,  0  }), OPC_REG),
	OPC("MNEGD",    OPC_nMNEGD,    2, OPR({ RD, WD, 0,  0,  0,  0  }), OPC_REG),
	OPC("TSTD",     OPC_nTSTD,     1, OPR({ RD, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("EMODD",    OPC_nEMODD,    5, OPR({ RD, RB, RD, WL, WD, 0  }), OPC_REG),
	OPC("POLYD",    OPC_nPOLYD,    3, OPR({ RD, RW, AB, 0,  0,  0  }), OPC_REG),
	OPC("CVTDF",    OPC_nCVTDF,    2, OPR({ RD, WF, 0,  0,  0,  0  }), OPC_REG),
	...
	OPC("ASHP",     OPC_nASHP,     6, OPR({ RB, RW, AB, RB, RW, AB }), OPC_REG),
	OPC("CVTLP",    OPC_nCVTLP,    3, OPR({ RL, RW, AB, 0 , 0 , 0  }), OPC_REG),
	...
	OPC("WAIT",     OPC_nWAIT,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("MFVP",     OPC_nMFVP,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("CVTDH",    OPC_nCVTDH,    2, OPR({ RD, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTGF",    OPC_nCVTGF,    2, OPR({ RG, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("VLDL",     OPC_nVLDL,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VGATHL",   OPC_nVGATHL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VLDQ",     OPC_nVLDQ,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VGATHQ",   OPC_nVGATHQ,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("ADDG2",    OPC_nADDG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_REG),
	OPC("ADDG3",    OPC_nADDG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_REG),
	OPC("SUBG2",    OPC_nSUBG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_REG),
	OPC("SUBG3",    OPC_nSUBG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_REG),
	OPC("MULG2",    OPC_nMULG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_REG),
	OPC("MULG3",    OPC_nMULG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_REG),
	OPC("DIVG2",    OPC_nDIVG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_REG),
	OPC("DIVG3",    OPC_nDIVG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_REG),

	OPC("CVTGB",    OPC_nCVTGB,    2, OPR({ RG, WB, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTGW",    OPC_nCVTGW,    2, OPR({ RG, WW, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTGL",    OPC_nCVTGL,    2, OPR({ RG, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTRGL",   OPC_nCVTRGL,   2, OPR({ RG, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTBG",    OPC_nCVTBG,    2, OPR({ RB, WG, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTWG",    OPC_nCVTWG,    2, OPR({ RW, WG, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTLG",    OPC_nCVTLG,    2, OPR({ RL, WG, 0,  0,  0,  0  }), OPC_REG),
	OPC("ACBG",     OPC_nACBG,     4, OPR({ RG, RG, MG, BW, 0,  0  }), OPC_REG),

	OPC("MOVG",     OPC_nMOVG,     2, OPR({ RG, WG, 0,  0,  0,  0  }), OPC_REG),
	OPC("CMPG",     OPC_nCMPG,     2, OPR({ RG, RG, 0,  0,  0,  0  }), OPC_REG),
	OPC("MNEGG",    OPC_nMNEGG,    2, OPR({ RG, WG, 0,  0,  0,  0  }), OPC_REG),
	OPC("TSTG",     OPC_nTSTG,     1, OPR({ RG, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("EMODG",    OPC_nEMODG,    5, OPR({ RG, RB, RG, WL, WG, 0  }), OPC_REG),
	OPC("POLYG",    OPC_nPOLYG,    3, OPR({ RG, RW, AB, 0,  0,  0  }), OPC_REG),
	OPC("CVTGH",    OPC_nCVTGH,    2, OPR({ RG, WH, 0,  0,  0,  0  }), OPC_REG),

	OPC("ADDH2",    OPC_nADDG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_REG),
	OPC("ADDH3",    OPC_nADDG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_REG),
	OPC("SUBH2",    OPC_nSUBG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_REG),
	OPC("SUBH3",    OPC_nSUBG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_REG),
	OPC("MULH2",    OPC_nMULG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_REG),
	OPC("MULH3",    OPC_nMULG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_REG),
	OPC("DIVH2",    OPC_nDIVG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_REG),
	OPC("DIVH3",    OPC_nDIVG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_REG),

	OPC("CVTHB",    OPC_nCVTHB,    2, OPR({ RH, WB, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTHW",    OPC_nCVTHW,    2, OPR({ RH, WW, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTHL",    OPC_nCVTHL,    2, OPR({ RH, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTRHL",   OPC_nCVTRHL,   2, OPR({ RH, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTBH",    OPC_nCVTBH,    2, OPR({ RB, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTWH",    OPC_nCVTWH,    2, OPR({ RW, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTLH",    OPC_nCVTLH,    2, OPR({ RL, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("ACBH",     OPC_nACBH,     4, OPR({ RH, RH, MH, BW, 0,  0  }), OPC_REG),

	OPC("MOVH",     OPC_nMOVH,     2, OPR({ RH, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("CMPH",     OPC_nCMPH,     2, OPR({ RH, RG, 0,  0,  0,  0  }), OPC_REG),
	OPC("MNEGH",    OPC_nMNEGH,    2, OPR({ RH, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("TSTH",     OPC_nTSTH,     1, OPR({ RH, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("EMODH",    OPC_nEMODH,    5, OPR({ RH, RB, RH, WL, WH, 0  }), OPC_REG),
	OPC("POLYH",    OPC_nPOLYH,    3, OPR({ RH, RW, AB, 0,  0,  0  }), OPC_REG),
	OPC("CVTHG",    OPC_nCVTHG,    2, OPR({ RH, WG, 0,  0,  0,  0  }), OPC_REG),

	OPC("CLRO",     OPC_nCLRO,     1, OPR({ WO, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("CLRH",     OPC_nCLRO,     1, OPR({ WO, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("MOVO",     OPC_nMOVO,     2, OPR({ RO, WO, 0,  0,  0,  0  }), OPC_REG),
	OPC("MOVAO",    OPC_nMOVAO,    2, OPR({ AO, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("MOVAH",    OPC_nMOVAO,    2, OPR({ AH, WL, 0,  0,  0,  0  }), OPC_REG),
	OPC("PUSHAO",   OPC_nPUSHAO,   1, OPR({ AO, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("PUSHAH",   OPC_nPUSHAO,   1, OPR({ AH, 0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVADDL",   OPC_nVVADDL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSADDL",   OPC_nVSADDL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVADDG",   OPC_nVVADDG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSADDG",   OPC_nVSADDG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVADDF",   OPC_nVVADDF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSADDF",   OPC_nVSADDF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVADDD",   OPC_nVVADDD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSADDD",   OPC_nVSADDD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VVSUBL",   OPC_nVVSUBL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSSUBL",   OPC_nVVSUBL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVSUBG",   OPC_nVVSUBG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSSUBG",   OPC_nVSSUBG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVSUBF",   OPC_nVVSUBF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSSUBF",   OPC_nVSSUBF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVSUBD",   OPC_nVVSUBD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSSUBD",   OPC_nVSSUBD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("CVTFH",    OPC_nCVTFH,    2, OPR({ RF, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTFG",    OPC_nCVTFG,    2, OPR({ RF, WG, 0,  0,  0,  0  }), OPC_REG),
	OPC("PROBEVMR", OPC_nPROBEVMR, 0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("PROBEVMW", OPC_nPROBEVMW, 0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSTL",     OPC_nVSTL,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSCATL",   OPC_nVSCATL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSTQ",     OPC_nVSTQ,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSCATQ",   OPC_nVSCATQ,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VVMULL",   OPC_nVVMULL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSMULL",   OPC_nVSMULL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVMULG",   OPC_nVVMULG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSMULG",   OPC_nVSMULG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVMULF",   OPC_nVVMULF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSMULF",   OPC_nVSMULF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVMULD",   OPC_nVVMULD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSMULD",   OPC_nVSMULD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VSYNC",    OPC_nVSYNC,    0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("MTVP",     OPC_nMTVP,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVDIVG",   OPC_nVVDIVG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSDIVG",   OPC_nVSDIVG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVDIVF",   OPC_nVVDIVF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSDIVF",   OPC_nVSDIVF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVDIVD",   OPC_nVVDIVD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSDIVD",   OPC_nVSDIVD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VVCMPL",   OPC_nVVCMPL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSCMPL",   OPC_nVSCMPL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVCMPG",   OPC_nVVCMPG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSCMPG",   OPC_nVSCMPG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVCMPF",   OPC_nVVCMPF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSCMPF",   OPC_nVSCMPF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVCMPD",   OPC_nVVCMPD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSCMPD",   OPC_nVSCMPD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VVBISL",   OPC_nVVBISL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSBISL",   OPC_nVSBISL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVBICL",   OPC_nVVBICL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSBICL",   OPC_nVSBICL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VVSRLL",   OPC_nVVSRLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSSRLL",   OPC_nVSSRLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVSLLL",   OPC_nVVSLLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSSLLL",   OPC_nVSSLLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("VVXORL",   OPC_nVVXORL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VSXORL",   OPC_nVSXORL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("VVCVT",    OPC_nVVCVT,    0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),
	OPC("IOTA",     OPC_nIOTA,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_VEC),

	OPC("CVTHF",    OPC_nCVTHF,    2, OPR({ RH, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTHD",    OPC_nCVTHD,    2, OPR({ RH, WD, 0,  0,  0,  0  }), OPC_REG),

	// Opcode 9200 - 02FF (00FE - FFFE)

	// Opcode 0300 - 03FF (00FF - FFFF)
	OPC("BUGL",     OPC_nBUGL,     1, OPR({ IL, 0,  0,  0,  0,  0  }), OPC_REG),
	OPC("BUGW",     OPC_nBUGW,     1, OPR({ IL, 0,  0,  0,  0,  0  }), OPC_REG),
