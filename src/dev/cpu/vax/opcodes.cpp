...
const vaxOpcode vaxOpcodes[] = {
	...
	OPC("ADDF2",    OPC_nADDF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("ADDF3",    OPC_nADDF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_SFL|UOPC),
	OPC("SUBF2",    OPC_nSUBF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("SUBF3",    OPC_nSUBF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_SFL|UOPC),
	OPC("MULF2",    OPC_nMULF2,    2, OPR({ RF, MF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("MULF3",    OPC_nMULF3,    3, OPR({ RF, RF, WF, 0,  0,  0  }), OPC_SFL|UOPC),
	...
	OPC("CVTFL",    OPC_nCVTFL,    2, OPR({ RF, WL, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("CVTRFL",   OPC_nCVTRFL,   2, OPR({ RF, WL, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("CVTBF",    OPC_nCVTBF,    2, OPR({ RB, WF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("CVTWF",    OPC_nCVTWF,    2, OPR({ RW, WF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("CVTLF",    OPC_nCVTLF,    2, OPR({ RL, WF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("ACBF",     OPC_nACBF,     4, OPR({ RF, RF, MF, BW, 0,  0  }), OPC_SFL|UOPC),

	OPC("MOVF",     OPC_nMOVF,     2, OPR({ RF, WF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("CMPF",     OPC_nCMPF,     2, OPR({ RF, RF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("MNEGF",    OPC_nMNEGF,    2, OPR({ RF, WF, 0,  0,  0,  0  }), OPC_SFL|UOPC),
	OPC("TSTF",     OPC_nTSTF,     1, OPR({ RF, 0,  0,  0,  0,  0  }), OPC_SFL|UOPC),
	...
	OPC("ADDD2",    OPC_nADDD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("ADDD3",    OPC_nADDD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_DFL|UOPC),
	OPC("SUBD2",    OPC_nSUBD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("SUBD3",    OPC_nSUBD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_DFL|UOPC),
	OPC("MULD2",    OPC_nMULD2,    2, OPR({ RD, MD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("MULD3",    OPC_nMULD3,    3, OPR({ RD, RD, WD, 0,  0,  0  }), OPC_DFL|UOPC),
	...
	OPC("CVTDL",    OPC_nCVTDL,    2, OPR({ RD, WL, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("CVTRDL",   OPC_nCVTRDL,   2, OPR({ RD, WL, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("CVTBD",    OPC_nCVTBD,    2, OPR({ RB, WD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("CVTWD",    OPC_nCVTWD,    2, OPR({ RW, WD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("CVTLD",    OPC_nCVTLD,    2, OPR({ RL, WD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("ACBD",     OPC_nACBD,     4, OPR({ RD, RD, MD, BW, 0,  0  }), OPC_DFL|UOPC),

	OPC("MOVD",     OPC_nMOVD,     2, OPR({ RD, WD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("CMPD",     OPC_nCMPD,     2, OPR({ RD, RD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("MNEGD",    OPC_nMNEGD,    2, OPR({ RD, WD, 0,  0,  0,  0  }), OPC_DFL|UOPC),
	OPC("TSTD",     OPC_nTSTD,     1, OPR({ RD, 0,  0,  0,  0,  0  }), OPC_DFL|UOPC),
	...
	OPC("ADDG2",    OPC_nADDG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("ADDG3",    OPC_nADDG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_GFL|UOPC),
	OPC("SUBG2",    OPC_nSUBG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("SUBG3",    OPC_nSUBG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_GFL|UOPC),
	OPC("MULG2",    OPC_nMULG2,    2, OPR({ RG, MG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("MULG3",    OPC_nMULG3,    3, OPR({ RG, RG, WG, 0,  0,  0  }), OPC_GFL|UOPC),
	...
	OPC("CVTGL",    OPC_nCVTGL,    2, OPR({ RG, WL, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("CVTRGL",   OPC_nCVTRGL,   2, OPR({ RG, WL, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("CVTBG",    OPC_nCVTBG,    2, OPR({ RB, WG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("CVTWG",    OPC_nCVTWG,    2, OPR({ RW, WG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("CVTLG",    OPC_nCVTLG,    2, OPR({ RL, WG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("ACBG",     OPC_nACBG,     4, OPR({ RG, RG, MG, BW, 0,  0  }), OPC_GFL|UOPC),

	OPC("MOVG",     OPC_nMOVG,     2, OPR({ RG, WG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("CMPG",     OPC_nCMPG,     2, OPR({ RG, RG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("MNEGG",    OPC_nMNEGG,    2, OPR({ RG, WG, 0,  0,  0,  0  }), OPC_GFL|UOPC),
	OPC("TSTG",     OPC_nTSTG,     1, OPR({ RG, 0,  0,  0,  0,  0  }), OPC_GFL|UOPC),
	...
	OPC("ADDH2",    OPC_nADDG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_HFL|UOPC),
	OPC("ADDH3",    OPC_nADDG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_HFL|UOPC),
	OPC("SUBH2",    OPC_nSUBG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_HFL|UOPC),
	OPC("SUBH3",    OPC_nSUBG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_HFL|UOPC),
	OPC("MULH2",    OPC_nMULG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_HFL|UOPC),
	OPC("MULH3",    OPC_nMULG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_HFL|UOPC),
	OPC("DIVH2",    OPC_nDIVG2,    2, OPR({ RH, MH, 0,  0,  0,  0  }), OPC_HFL|UOPC),
	OPC("DIVH3",    OPC_nDIVG3,    3, OPR({ RH, RH, WH, 0,  0,  0  }), OPC_HFL|UOPC),
