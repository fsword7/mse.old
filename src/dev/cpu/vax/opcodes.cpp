...
const vaxOpcode vaxOpcodes2[] = {
	...
	OPC("MFVP",     OPC_nMFVP,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("CVTDH",    OPC_nCVTDH,    2, OPR({ RD, WH, 0,  0,  0,  0  }), OPC_REG),
	OPC("CVTGF",    OPC_nCVTGF,    2, OPR({ RG, WF, 0,  0,  0,  0  }), OPC_REG),
	OPC("VLDL",     OPC_nVLDL,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VGATHL",   OPC_nVGATHL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VLDQ",     OPC_nVLDQ,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VGATHQ",   OPC_nVGATHQ,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	...
	OPC("VVADDL",   OPC_nVVADDL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSADDL",   OPC_nVSADDL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVADDG",   OPC_nVVADDG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSADDG",   OPC_nVSADDG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVADDF",   OPC_nVVADDF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSADDF",   OPC_nVSADDF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVADDD",   OPC_nVVADDD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSADDD",   OPC_nVSADDD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVSUBL",   OPC_nVVSUBL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSSUBL",   OPC_nVSSUBL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVSUBG",   OPC_nVVSUBG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSSUBG",   OPC_nVSSUBG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVSUBF",   OPC_nVVSUBF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSSUBF",   OPC_nVSSUBF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVSUBD",   OPC_nVVSUBD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSSUBD",   OPC_nVSSUBD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	...
	OPC("VSTL",     OPC_nVSTL,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSCATL",   OPC_nVSCATL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSTQ",     OPC_nVSTQ,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSCATQ",   OPC_nVSCATQ,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVMULL",   OPC_nVVMULL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSMULL",   OPC_nVSMULL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVMULG",   OPC_nVVMULG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSMULG",   OPC_nVSMULG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVMULF",   OPC_nVVMULF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSMULF",   OPC_nVSMULF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVMULD",   OPC_nVVMULD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSMULD",   OPC_nVSMULD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VSYNC",    OPC_nVSYNC,    0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("MTVP",     OPC_nMTVP,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVDIVG",   OPC_nVVDIVG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSDIVG",   OPC_nVSDIVG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVDIVF",   OPC_nVVDIVF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSDIVF",   OPC_nVSDIVF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVDIVD",   OPC_nVVDIVD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSDIVD",   OPC_nVSDIVD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVCMPL",   OPC_nVVCMPL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSCMPL",   OPC_nVSCMPL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVCMPG",   OPC_nVVCMPG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSCMPG",   OPC_nVSCMPG,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVCMPF",   OPC_nVVCMPF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSCMPF",   OPC_nVSCMPF,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVCMPD",   OPC_nVVCMPD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSCMPD",   OPC_nVSCMPD,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVBISL",   OPC_nVVBISL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSBISL",   OPC_nVSBISL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVBICL",   OPC_nVVBICL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSBICL",   OPC_nVSBICL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVSRLL",   OPC_nVVSRLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSSRLL",   OPC_nVSSRLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVSLLL",   OPC_nVVSLLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSSLLL",   OPC_nVSSLLL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),

	OPC("VVXORL",   OPC_nVVXORL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VSXORL",   OPC_nVSXORL,   0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("VVCVT",    OPC_nVVCVT,    0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
	OPC("IOTA",     OPC_nIOTA,     0, OPR({ 0,  0,  0,  0,  0,  0  }), OPC_REG),
